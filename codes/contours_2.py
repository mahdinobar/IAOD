"""
GMM, K=5, with initial condition without background,3 features, remove background, no PCA:
"""
from open3d import *
import cv2 as cv
import open3d
...
# np.save("image_contours_2.npy",image)
# np.save("depth_contours_2.npy",depth)
image =np.load("image_contours_2.npy")
depth=np.load("depth_contours_2.npy")
...
cv.drawContours(image_contours, contours[1:6], -1, (0,255,0), 3)

...
this works for 5 parts far from each other
input point cloud that worked is:
BGM_5objects_far.ply
...
open3d.write_point_cloud('pcd_bgm_raw_data_more_space.ply', pcd)

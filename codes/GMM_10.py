...
# image_3, _ = freenect.sync_get_video()
# image_3 = image_3[ref_point[0][1]:ref_point[1][1], ref_point[0][0]:ref_point[1][0]]
# image_3 = cv.cvtColor(image_3, cv.COLOR_RGB2BGR)
# image_3 = image_3.astype(np.uint8)
# depth_3, _ = freenect.sync_get_depth(format=freenect.DEPTH_REGISTERED)
# depth_3 = depth_3[ref_point[0][1]:ref_point[1][1], ref_point[0][0]:ref_point[1][0]]
# depth_3 = depth_3.astype(np.uint8)
# np.save('GMM_10_midpresentation_image_3.npy', image_3)
# np.save('GMM_10_midpresentation_depth_3.npy', depth_3)
# while 1:

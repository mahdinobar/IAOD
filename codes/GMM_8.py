"""
This code works for detecting the object which is missing from the original image (one object removed out) using GMM trained for each contours seperately
and 2 features (x,y)
"""
...
# close_device(mdev)
# image_2 = get_cropped_video()
# depth_2=get_cropped_depth()

...
# np.save('image_smallobject_position_1.npy', image_source)
# np.save('depth_smallobject_position_1.npy', depth_source)
# np.save('depth_2parts_1.npy', depth_source)
...
# image_source=np.load('image_2parts_1.npy')
# depth_source=np.load('depth_2parts_1.npy')
...
# np.save('image_smallobject_position_2.npy', image_2_source)
# np.save('image_smallobject_position_2.npy', depth_2_source)
# np.save('depth_2parts_2.npy', depth_2_source)
...
# image_2_source=np.load('image_2parts_2.npy')
# depth_2_source=np.load('depth_2parts_2.npy')
...
# np.save('image_smallobject_position_1.npy', image_target)
# np.save('depth_2parts_3.npy', depth_target)
# image_target=np.load('image_2parts_3.npy')
# depth_target=np.load('depth_2parts_3.npy')
# while 1:
...
# np.save('image_smallobject_position_2.npy', image_2_target)
# np.save('depth_2parts_4.npy', depth_2_target)
# image_2_target=np.load('image_2parts_4.npy')
# depth_2_target=np.load('depth_2parts_4.npy')
# while 1:
...
mean_set_1,cov_set_1 = model(image_source,depth_source,image_target=None,depth_target=None).model_3()
mean_set_2,cov_set_2=model(image_2_source,depth_2_source,image_target=None,depth_target=None).model_3()

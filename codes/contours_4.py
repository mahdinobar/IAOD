"""
GMM for 7 parts, K=7, with initial condition without background,3 features, remove background, no PCA:
This code works fine with "depth_contours_4.npy" and "image_contours_4.npy"

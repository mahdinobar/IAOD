...
this scripts works for SOME(e.g 2 and 3 from GMM_6) of two objects("GMM_6_image_2_objects.npy" and "GMM_6_depth_2_objects.npy") matching with 7 object ground truth we have from GMM_6
...
image =np.load("GMM_6_image_2_objects.npy")
depth=np.load("GMM_6_depth_2_objects.npy")
...
X=X[X[:,2]<0.3,:]#we remove out the background here
X_copy=np.copy(X)
X=X[:,0:3]

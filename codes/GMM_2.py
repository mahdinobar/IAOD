"""
here we apply background removal to GMM_1
The last challenge:

it detects 2 or 3 features for some gears
"""
...
np.save("raw_DATA_last_run_GMM_2.npy",X)
...
# DB=[]
k1=2
n_components_range = range(k1, k1+10)
# cv_types = ['spherical','diag','full']
cv_types = ['full']
for cv_type in cv_types:
    for n_components in n_components_range:
